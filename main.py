...
from routes import router_websocket, router_custom_categories, router_custom_items, router_custom_users
...
app.include_router(router_custom_categories)
app.include_router(router_custom_items)
app.include_router(router_custom_users)
